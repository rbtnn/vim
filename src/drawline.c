...
# endif
	...
	{
	    screen_line(wp, screen_row, wp->w_wincol + TABSBLC(wp), col, -wp->w_width,
							    screen_line_flags);
...
# endif
	    ...
	    screen_line(wp, screen_row, wp->w_wincol + TABSBLC(wp), col,
...
# endif
	...
	{
#ifdef FEAT_CONCEAL
	    screen_line(wp, screen_row, wp->w_wincol + TABSBLC(wp), col - boguscols,
					  wp->w_width, screen_line_flags);
	    boguscols = 0;
#else
	    screen_line(wp, screen_row, wp->w_wincol + TABSBLC(wp), col,
